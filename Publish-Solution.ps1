# framework-dependent
dotnet publish AutoCEMI.CLI\AutoCEMI.CLI.csproj -c Release -o .\publish\cli-win-x64-framework-dependent
dotnet publish AutoCEMI.GUI\AutoCEMI.GUI.csproj -c Release -o .\publish\gui-win-x64-framework-dependent
